                ...
                <div className='relative flex flex-col justify-around lg:px-10 w-full sm:w-3/4'>
                    <div className='w-full sm:px-10 lg:px-0'>
                        ...
                        <div className="cursor-default">
                            Upcoming graduate from the Software Design and Development program with experience in creating database structures, designing dynamic and static web environments for cloud-based management or storage, and developing mobile applications for Android and iOS. I also possed problem-solving abilities, effective communication skills, and adaptability.
                        </div>
                    </div>
