...
export default function JavaScriptPortfolio() {
    ...
    const javascriptData = [
        ...
        },
        {
            title: 'GuessNumber',
            chips: ['Html 5', 'JavaScript', 'TailwindCSS'],
            image: '/projects/guessnumber-tiny.jpg',
            href: 'https://guess-number-one-sage.vercel.app/'
        },
    ];
    ...
    return (
        <div className="grid gap-6 sm:grid-cols-2 grid-cols-1">
            ...
            <div className="grid gap-6 grid-cols-2 text-white">
                <div className="col-span-2 border  border-zinc-600 rounded-lg pb-4 bg-zinc-950">
                    <div className="py-4 flex justify-center items-center h-3/5">Fibonacci</div>
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 w-full  px-6 text-center">
                        <Chip>JavaScript</Chip>
                        <Chip>Tailwind CSS</Chip>
                    </div>
                </div>

                <div className="border col-span-2  border-zinc-600 rounded-lg h-full flex justify-center pb-4 items-center bg-zinc-950">
                    <div className="flex flex-col items-center justify-center h-full">
                        ...
                        <div>
                            <div className="border border-zinc-700 rounded-lg py-1 text-sm px-4 transition ease-in-out hover:scale-105 hover:bg-gradient-to-b hover:from-zinc-600 hover:border-white">
                                <a href="https://github.com/LihuisiEd/Portfolio-JavaScript" target="_blank">Portfolio on Github</a>
                            </div>
                        </div>
                    </div>
                </div>
